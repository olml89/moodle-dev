...
/var/www/html/moodle. Your plugins will live in /var/www/html/moodle/* (in auth, local, etc, depending on the plugin type).
...
/var/www/html/moodle/* in the container. This should be enough to be able to debug your the Moodle
